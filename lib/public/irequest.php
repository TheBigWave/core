...
interface IRequest {
	...
	*/
	 ...
	 */
	public function isUserAgent($agent);
	 ...
	 * @return string|null overwritehost value or null if not defined or the
	 * defined condition isn't met
	 */
	public function getOverwriteHost();
}
